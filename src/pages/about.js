...
export const getStaticProps = async () => {
  ...
  return {
    props: { data: data.data.aboutPage },
  };
};
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <p>
              ...
              dalam kawasan kota mandiri / township, menginisiasi Sinarmas Land
              untuk membangun kota mandiri Grand Wisata Bekasi di timur Jakarta
              yang lengkap dengan fasilitas residential yang asri, commercial
              yang serba lengkap serta menunjang lifestyle masa kini.
            </p>
            <p>
            ...
            <p>
              Berada di lahan seluas 1.100 Ha, lokasi Grand Wisata Bekasi hanya
              berjarak 15 menit ke Jakarta dan 5 menit ke kawasan ekonomi &
              industri terpadu terbesar di Indonesia (Kawasan Industri MM2100)
              membuat Grand Wisata Bekasi menjadi kota mandiri berprospek tinggi
              sebagai supporting township bagi 4000 perusahaan multinasional
              dari 30 negara.
            </p>
          </div>
        </div>
          ...
          <div className="col-md-6 d-flex justify-content-sm-center align-items-sm-center">
            <div>
              ...
              <p>
                ...
                beragam fasilitas seperti Mall Living World Grand Wisata, rumah
                sakit, sekolah berkualitas, modern market, tempat berbisnis dan
                tempat rekreasi bertaraf internasional di dalam Grand Wisata
                Bekasi.
              </p>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-12 text-center">
            ...
            <p>
              ...
              yang turut serta membangun Indonesia selama 40 tahun di 26 kota di
              Indonesia dan 5 negara.
            </p>
          </div>
        </div>
      </section>
